...
Input files: 
- 107_522_2021_LM_<YYYY>.csv.finreg_IDs
- 107_522_2021_LT_<YYYY>.csv.finreg_IDs

Output files: 
- prescriptions_<YYYY>_<YYYY-MM-DD>.csv
- deliveries_<YYYY>_<YYYY-MM-DD>.csv
"""
...
from finregistry_data.config import KELA_KANTA_INPUT_DIR
...
def get_output_filepath(input_filepath):
    ...
    output_filename = filetype + "_" + year + ".csv"
